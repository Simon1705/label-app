...
import { FiUser, FiSave, FiX, FiUserPlus, FiShield, FiAlertCircle } from 'react-icons/fi';
  ...
  return (
    ...
    >
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Create New User</h1>
      </div>
